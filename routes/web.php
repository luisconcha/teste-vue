...
Route::prefix('admin')->group(function () {
    ...
    Route::group(['namespace' => 'Admin\\', 'as' => 'admin.', 'middleware' => ['auth', 'can:admin']], function () {
    ...
    Route::group(['prefix' => 'api', 'namespace' => 'Api\\', 'as' => 'admin.api.', 'middleware' => ['auth', 'can:admin']], function () {
